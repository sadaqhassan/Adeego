...
return (
          <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-primary to-secondary text-white/70">
                  <h1 className="text-2xl md:text-3xl text-white">Adeego.store</h1>
                  <p>Creatd by sadak Hassan</p>
                <p className="mt-4 text-center">Copyright © 2025 <a href="https://prebuiltui.com">Adeego</a>. All rights reservered.</p>
